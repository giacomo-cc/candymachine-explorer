...
const CANDY_MACHINE_PROGRAM = new web3.PublicKey("cndyAnrLdpjq1Ssp1z8xxDsB8dxe7u4HL5Nxi2K5WXZ");
...
export async function fetchCandyMachineState(
  ...
  try {
    ...
    const accountConfig: any = await program.account.config.fetch(accountCandyMachine.config.toBase58());
